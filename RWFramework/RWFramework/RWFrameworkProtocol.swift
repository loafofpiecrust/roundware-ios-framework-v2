...
@objc public protocol RWFrameworkProtocol: class {
    ...
    @objc optional func rwPostUsersFailure(_ error: NSError?)
    ...
    @objc optional func rwPostSessionsFailure(_ error: NSError?)
    ...
    @objc optional func rwPostStreamsFailure(_ error: NSError?)
    ...
    @objc optional func rwPatchStreamsIdFailure(_ error: NSError?)
    ...
    @objc optional func rwPostEnvelopesFailure(_ error: NSError?)
    ...
    @objc optional func rwPatchEnvelopesIdFailure(_ error: NSError?)
    ...
    @objc optional func rwGetAssetsFailure(_ error: NSError?)
    ...
    @objc optional func rwGetAssetsIdFailure(_ error: NSError?)
    ...
    @objc optional func rwPostAssetsIdVotesFailure(_ error: NSError?)
    ...
    @objc optional func rwPostEventsFailure(_ error: NSError?)
...
// MARK: callers
    ...
    func rwPostStreamsFailure(_ error: NSError?) {
        protocaller { (rwfp, _) -> Void in
    ...
    func rwPostStreamsIdHeartbeatFailure(_ error: NSError?) {
        protocaller { (rwfp, _) -> Void in
    ...
    func rwPostAssetsIdVotesFailure(_ error: NSError?) {
        protocaller { (rwfp, _) -> Void in
    ...
    func rwGetAssetsIdVotesFailure(_ error: NSError?) {
        protocaller { (rwfp, _) -> Void in
    ...
    func rwPostEventsFailure(_ error: NSError?) {
        protocaller { (rwfp, _) -> Void in
